...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        JavaArraysExercises.arraysTwoDimensionalExercise();
...
//        System.out.println(JavaBooleansExercises.firstExercise( true));
//        System.out.println(JavaBooleansExercises.booleanExpressionOne(72, 102));
