...
public class JavaMathExercises {
    ...
    public static double mathExerciseThree(double a, double b) {
        return Math.max(a, b);
    }

    public static double mathExerciseFour(double a, double b) {
        return Math.min(a, b);
    }

    public static double mathExerciseFive(double a, double b){
        return Math.pow(a, b);
    }
    ...
    public static double floorExercise(double a) {
        return Math.floor(a);
    }
    ...
    public static long absExercise2(long a) {
